...
# Website Link:  <p style="font-size: 1.2rem;">https://carmenk321publishing.github.io/PublishingPortfolio/</p>
...
🚧 **Work in progress.** Needs-analysis summaries and product details are currently placeholders and are being finalized case by case. Not yet ready for public sharing.

## Live site

Once complete, this repo is published via GitHub Pages at:
`https://carmenk321publishing.github.io/PublishingPortfolio/`

## About the collection

Each case study is built around a real (or representative) learner need, a clear can-do objective, and CEFR-aligned language/skills focus, following a consistent product-brief → draft → editorial review → final-build workflow.
